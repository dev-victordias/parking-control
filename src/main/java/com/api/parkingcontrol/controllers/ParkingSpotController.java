...
public class ParkingSpotController {
    ...
    public ResponseEntity<Object> saveParkingSpot(
        ...
        if(parkingSpotService.existsByLicensePlateCar(
                parkingSpotDto.getLicensePlateCar())){
            
            return ResponseEntity.status(HttpStatus.CONFLICT)
                    .body("Conflict: License Plate Car is already used!");
    ...
    public ResponseEntity<Object> updateParkingSpot(
            ...
            parkingSpotModel.setRegistrationDate(parkingSpotModelOptional.get()
                    .getRegistrationDate());
